...
Useful reference documentation on properties files for spring boot: https://docs.spring.io/spring-boot/docs/current/reference/html/howto-properties-and-configuration.html
